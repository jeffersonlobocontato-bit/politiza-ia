...
export const municipalities: Municipality[] = [
  { id: 'curitiba', name: 'Curitiba', macroregion: 'curitiba', microregion: 'Curitiba', lat: -25.4244, lng: -49.2654, population: 1963726, electoralVoters: 1181000, engagementScore: 82, actionsPlanned: 45, actionsCompleted: 38, actionsDelayed: 3, peopleImpacted: 125000, pollScore: 49.3, coordinator: '' },
...
export const actions: Action[] = [
  ...
  { id: 'a014', title: 'Ação Digital RMC — Engajamento Online', type: 'acao_digital', category: 'Digital', description: 'Campanha digital geolocalizada para eleitores da Região Metropolitana.', municipality: 'Curitiba', microregion: 'Curitiba', macroregion: 'curitiba', address: 'Online — RMC', lat: -25.4340, lng: -49.2750, responsible: 'Carlos Mendonça', team: ['Equipe Digital'], plannedDate: '2024-05-05', plannedTime: '00:00', priority: 'alta', targetAudience: 'Usuários de redes sociais na RMC', estimatedImpact: 180000, status: 'realizada', executedDate: '2024-05-05', executedPeopleCount: 210000 },
...
export const polls: PollData[] = [
  ...
  { id: 'p002', institute: 'IBOPE Regional', collectionDate: '2024-07-12', releaseDate: '2024-07-15', scope: 'Regional', territory: 'Curitiba', sampleSize: 600, marginOfError: 4.0, methodology: 'Telefônica', scenario: '1º Turno', votingIntention: 47.2, rejection: 23.8, undecided: 15.4, votePool: 59.1 },
...
export const politicalAssets: PoliticalAsset[] = [
  ...
  { id: 'pa011', name: 'Vera Lúcia Moraes', type: 'lideranca_comunitaria', municipality: 'Curitiba', microregion: 'Curitiba', macroregion: 'curitiba', position: 'Presidente Conselho Comunitário Bairro Alto', influenceLevel: 7, alignmentStatus: 'alinhado', supportStatus: 'Mobilizadora ativa', observations: 'Referência na periferia norte de Curitiba. Rede de 800 líderes de rua.', lat: -25.3500, lng: -49.2900 },
