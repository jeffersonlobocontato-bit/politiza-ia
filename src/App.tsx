...
import CampoMembros from "./pages/CampoMembros";
import CampoProdutividade from "./pages/CampoProdutividade";
...
import RedatorGazeta from "./pages/RedatorGazeta";
...
import AppLogistica from './pages/AppLogistica';
...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/app-logistica" element={<ProtectedRoute><AppLogistica /></ProtectedRoute>} />
